...
/// files and tickets, plus a ticket-drafting tool. See the tool descriptions in
/// <see cref="BuildTools"/> for the behavioral constraints (scoped access, explicit-request-only
/// drafting) enforced through prompting rather than code.
/// </summary>
    ...
    IValidator<SendChatMessageRequest> sendValidator) : ILiveAgentChatService
{
    ...
    [
        ...
        new LlmToolDefinition(
            "list_tickets",
            "List this project's tickets, optionally filtered by status, to answer questions about existing work.",
        ...
        new LlmToolDefinition(
            ...
            "log, or file a ticket - never propose one on your own initiative from a general question. This does not " +
