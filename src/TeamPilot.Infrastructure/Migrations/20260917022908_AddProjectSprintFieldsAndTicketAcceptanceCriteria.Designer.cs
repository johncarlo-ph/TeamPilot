...
namespace TeamPilot.Infrastructure.Migrations
{
    ...
    [Migration("20260917022908_AddProjectSprintFieldsAndTicketAcceptanceCriteria")]
    partial class AddProjectSprintFieldsAndTicketAcceptanceCriteria
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamPilot.Domain.Entities.ChatMessage", b =>
                {
                    ...
                    b.Property<string>("ProposedTicketAcceptanceCriteria")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TeamPilot.Domain.Entities.StageExecution", b =>
                {
                    ...
                    b.HasIndex("TicketId", "AgentId", "CreatedAtUtc");
            ...
            modelBuilder.Entity("TeamPilot.Domain.Entities.TicketAgentEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TeamPilot.Domain.Entities.TicketQuestion", b =>
                {
                    ...
                    b.ToTable("TicketQuestions", (string)null);
                });
